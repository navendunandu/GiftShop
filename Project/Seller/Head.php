...
<body>
  ...
  <header>
    ...
    <div class="container-fluid" style="background: #f9f3ec;">
      <hr class="m-0">
    </div>
      ...
      <nav class="main-menu d-flex navbar navbar-expand-lg ">
        ...
        <div class="d-flex d-lg-none align-items-end mt-3">
          <!-- <ul class="d-flex justify-content-end list-unstyled m-0">
            <li>
              <a href="Myprofile.php" class="mx-3">
            ...
            <li>
              <a href="MyCart.php" class="mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
            ...
            <li>
              <a href="Search.php" class="mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch"
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body justify-content-between">
            ...
            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
              <li class="nav-item">
                <a href="SellerHomepage.php" class="nav-link active">Home</a>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pages">
                  <li><a href="Myprofile.php" class="dropdown-item">Myprofile</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pages">
                  <li><a href="Product.php" class="dropdown-item">Add Product</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pages">
                  <li><a href="Bookings.php" class="dropdown-item">User Booking</a></li>
