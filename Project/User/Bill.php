...
$selqry=" select * from tbl_booking  b inner join tbl_user u on u.user_id = b.user_id where b.booking_id='".$id."'";
    ...
    <section class="main-pd-wrapper" style="width: 1000px; margin: auto" id="content">
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">Fruitkha</span>
      ...
      >
        ...
        $total=0;
          ...
          <tr>
            <td><?php echo $i ?></td>
            <td><?php echo $res1["product_name"] ?></td>
            <td><img src="../Assets/Files/Userdocs   /<?php echo $res1["product_photo"];?>" width="119" height="92" /></td>
            <td><?php echo $res1["product_price"] ?></td>
            <td><?php echo $res1["cart_quantity"] ?></td>
            <td><?php echo $res1["product_price"] * $res1["cart_quantity"] ?></td>
          </tr>
      ...
      <tr style="background: #fcbd02">
        ...
        <tr style="background: #fcbd02">
          ...
          <td style="width: 100px; text-align: right; border-right: none">
          <b><?php echo number_format($total + $gst + 40, 2)." Rs" ?></b>
          </td>
          <td colspan="5" style="border-left: none"></td>
        </tr>
      </table>
      <P align="center"><a href="Mybooking.php">MyBooking</a></P>
    </section>
